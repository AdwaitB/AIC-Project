...
class LocalModel(object):
    def __init__(self, model_config, data_collected):
        ...
        self.x_valid = valid_data.drop(['target'], axis=1)
        self.y_valid = valid_data.target
    ...
    def aggregate_train_loss_accuracy(self, client_losses, client_accuracies, client_sizes, cur_round):
        ...
        aggr_loss, aggr_accuraries, aggr_size = self.aggregate_loss_accuracy(client_losses, client_accuracies,
                                                                             client_sizes)
