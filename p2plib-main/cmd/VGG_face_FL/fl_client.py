...
class LocalModel(object):
    ...
    def train_one_round(self):
        ...
        self.model.fit(self.x_train[0:8], self.y_train[0:8],
                  ...
                  batch_size=2,
                  verbose=1,
                  validation_data=(self.x_valid[0:20], self.y_valid[0:20]),callbacks=[csv_logger])
...
class FederatedClient(object):
    ...
    def register_handles(self):
        ...
        def on_init(data):
            ...
            # TODO use datasource.get_data() to get the tf dataset object here
            # TODO then comment out lines 169 - 179
            if os.path.exists("fake_data") and os.path.exists("my_class_distr"):
                ...
                # print(fake_data)
                # storeData("fake_data1",fake_data)
                # storeData("my_class_distr1",my_class_distr)
