...
class FederatedClient(object):
    ...
    #def __init__(self, host, port, bootaddr, datasource, mytraintime, mynumleave):
        ...
        # mytraintime and mynumleave are for debug
    ...
    def register_handles(self):
        ...
        def on_train_my_model(arg):
            ...
            time.sleep(mytraintime)
            print("my train done : " + str(mytraintime) + str("\n"))
...
if __name__ == "__main__":
    ...
    # for debug
    #mytraintime = int(sys.argv[4])
    #mynumleave = int(sys.argv[5])
    #client = FederatedClient(sys.argv[1], sys.argv[2], sys.argv[3], datasource.VggFace2, mytraintime, mynumleave)
