...
class FLServer(object):
    #MIN_NUM_WORKERS = 7 # total clients (publisher and FL server are not included here) TODO : pass this to FL server
    #MAX_NUM_ROUNDS = 3 #TODO : pass this to FL server
    #NUM_CLIENTS_CONTACTED_PER_ROUND = 1 obsolete
    ...
    def __init__(self, global_model, host, port, bootaddr):
        ...
        self.wakeup_client_sids = set()
        self.ready_lower_clients = 0
        self.wakeup_lower_clients = 0
        ...
        #self.lib.Broadcast_BC.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_byte]
        #self.lib.Multicast_GR.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_byte]
